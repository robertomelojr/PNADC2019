#O presente script foi utilizado para verificar se é ou não válido utilizar a base da PNADC2019, pois é preciso verificar se a mesma reflete a realidade das variáveis de interesse.
